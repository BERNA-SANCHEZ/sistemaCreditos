...
function mostrarProductos($idPrestamo)
{
	...
	$sql="SELECT *, date_format(fechapago, '%d-%m-%Y') as fechapago_formateada FROM detprestamos WHERE idprestamo = ".$idPrestamo." AND id != (SELECT MIN(id) FROM detprestamos WHERE idprestamo = ".$idPrestamo." )";
	...
	if ($_GET['tipo'] == 3 || $_GET['tipo'] == 4) {

		for ($i=1; $i <= $filas ; $i++) { 

			$contenidoTabla.="<tr><td>{$contador}</td>";	
			
			if ($contador < count($detalle) && $contador != "") {$contador++;}else{$contador = "";}
			
			$contenidoTabla.="<td>{$contador}</td>";		
			if ($contador < count($detalle) && $contador != "") {$contador++;}else{$contador = "";}
			...
			$contenidoTabla.="<td>{$contador}</td></tr>";
			if ($contador < count($detalle) && $contador != "") {$contador++;}else{$contador = "";}
...
<tr>
	...
	<img style="vertical-align: top"  src="../images/logopdf.jpg"  width="250" >
	</td>
...
if ($_GET['tipo'] == 3 || $_GET['tipo'] == 4) {
	...
	<table width="100%" style="font-size: 9pt; border-collapse: collapse; border: solid; border-color: #FFFFFF; border-width: 1px;" cellpadding="4">
	   <tbody>
			<tr>
				<td width="100%">
					Favor cualquier adelanto o inconveniente comunicarse al número de Don Roger <b>42103766</b>, Don Julio Franco <b>48380867</b>
				</td>			
			</tr>    	   	   
	   </tbody>
	</table>
	...
	<table class="items" width="100%" style="font-size: 7pt; border-collapse: collapse;" cellspacing="3" cellpadding="3">
	<tbody> ';
	...
	<table width="100%" style="font-family: serif;" cellspacing="4" cellpadding="4"><tr>
	<td width="56%" style="border: 0.1mm solid #888888; font-size: 9pt;"><span style="font-size: 7pt; color: #555555; font-family: sans;">DATOS DEL CLIENTE:</span><br /><br /> '.$contenidoDatosCliente.' '.$fechaIniciofechaFin.' </td>
	<td width="2%">&nbsp;</td>
	<td width="42%" style="border: 0.1mm solid #888888; font-size: 9pt;"><span style="font-size: 7pt; color: #555555; font-family: sans;">DATOS DEL PRÉSTAMO:</span><br /><br /> '.$contenidoDatosPrestamo.' </td>
	</tr></table>
	...
	<table width="100%" style="font-size: 9pt; border-collapse: collapse; border: solid; border-color: #FFFFFF; border-width: 1px;"  cellspacing="2" cellpadding="2">
	<tbody>
			<tr>
				<td width="100%">
					Favor cualquier adelanto o inconveniente comunicarse al número de Don Roger <b>42103766</b>, Don Julio Franco <b>48380867</b>
	...
	<table class="items" width="100%" style="font-size: 7pt; border-collapse: collapse;" cellspacing="2" cellpadding="2">
	<thead>
	<tr>
	<td >#</td>
	<td >VALOR</td>
...
<table width="100%" style="font-size: 7pt; border-collapse: collapse; border: solid; border-color: #FFFFFF; border-width: 1px;" cellspacing="2" cellpadding="2">

   <tbody>

		<tr>
			<td>
			*Los pagos reflejados en esta tabla debidamente firmados por asesor y cliente serán los tomados dentro de la amortización del crédito.
			</td>				
		</tr>

		<tr>						
			<td>
			*La mora descrita en esta tabla afectará para la baja de interés y aumentos en futuros créditos.			
			</td>					
		</tr>

		<tr>		
			<td style="border-bottom: 2px solid #000;">
				*Acepto las condiciones del crédito y las consecuencias mencionadas anteriormente.			
			</td>	
		</tr>
